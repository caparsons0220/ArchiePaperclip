...
// Archie Bravo mark: rounded square face icon + wordmark, vertically centered
const ARCHIE_BRAVO_LOGO_SVG = `<g>
  <g transform="translate(0 0)">
    <rect x="0.9" y="0.9" width="18.2" height="18.2" rx="5" fill="none" stroke="currentColor" stroke-width="1.6"/>
    <path d="M4.4 7.7C5.5 5.9 7.8 4.9 9.6 4.9" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/>
    <path d="M10.4 4.9C12.2 4.9 14.5 5.9 15.6 7.7" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/>
    <ellipse cx="8" cy="12" rx="2" ry="3.1" fill="currentColor"/>
    <path d="M9.7 10.4L7.7 12L9.7 13.6Z" fill="white"/>
    <ellipse cx="12" cy="12" rx="2" ry="3.1" fill="currentColor"/>
    <path d="M10.3 10.4L12.3 12L10.3 13.6Z" fill="white"/>
    <path d="M7.5 16C8.8 17.1 11.2 17.1 12.5 16C11.8 17.5 8.2 17.5 7.5 16Z" fill="currentColor"/>
  </g>
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">Archie Bravo</text>
</g>`;
